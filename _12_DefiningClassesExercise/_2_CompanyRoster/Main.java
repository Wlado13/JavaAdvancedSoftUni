...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Department hieghestPaidDepartment = departments.get(0);
        Collections.sort(hieghestPaidDepartment.getEmployees(),Comparator.comparing(Employee::getSalary).reversed());

        System.out.println(hieghestPaidDepartment.toString());
    }
